...
| [4ku](https://github.com/kz04px/4ku) | [The 4ku devs](https://github.com/kz04px) | Chess | 2690 | A UCI chess engine in 4 kB. The 4ku-mini script contains compressed C++ source code, that is extracted and compiled before being run. Written to take part in the TCEC's 4K tournament: https://wiki.chessdom.org/TCEC_4k_Rules |
