...
| [Viridithas](https://github.com/cosmobobak/viridithas) 10.0.0 | [Cosmo Bobak](https://github.com/cosmobobak) | 3384 | 3526 | The strongest UK chess engine & the strongest Rust chess engine. |
...
| [Alexandria](https://github.com/PGG106/Alexandria) 4.0 | [Zuppa D. Cipolle](https://github.com/PGG106) | ↓3258 | 3509 | Strong C engine with VICE ancestry. |
| [Rice](https://github.com/rafid-dev/rice) 7.0.0 | [Rafid](https://github.com/rafid-dev) | 3333 | 3473 | Written in C++ |
| [BlackCore](https://github.com/SzilBalazs/BlackCore) 6.0 | [Szil](https://github.com/SzilBalazs) | 3311 | 3429 | Very strong NNUE implementation. |
| [Smallbrain](https://github.com/Disservin/Smallbrain) 7.0.0 | [Disservin](https://github.com/Disservin) | 3307 | 3434 | Supports FRC & uses self-generated NNUE data. |
| [Stormphrax](https://github.com/Ciekce/Stormphrax) 1.0.0 | [Ciekce](https://github.com/Ciekce) | ~3280 | 3361 | Successor to Polaris; another NNUE engine that learnt to evaluate from zero knowledge. |
| [StockDory](https://github.com/TheBlackPlague/StockDory) 08012023 | [Shaheryar Sohail](https://github.com/TheBlackPlague) | ↓3250 | * | C++ rewrite of StockNemo. |
...
| [Stash](https://gitlab.com/mhouppin/stash-bot) 34.0 | [Morgan Houppin](https://gitlab.com/mhouppin) | 3214 | 3311 | Another very strong HCE engine. [Doesn't support tablebases.](http://talkchess.com/forum3/viewtopic.php?f=2&t=76927#p888045) |
| [Weiss](https://github.com/TerjeKir/weiss) 2.0 | [Terje](https://github.com/TerjeKir) | 3208 | 3318 | A very strong VICE descendant, and one of the strongest HCE engines. |
| [StockNemo](https://github.com/TheBlackPlague/StockNemo) Stingray 5.7.0.0 | [Shaheryar Sohail](https://github.com/TheBlackPlague) | 3189 | ↓2934 | Written in C#! |
| [Drofa](https://github.com/justNo4b/Drofa) 4.0.0 | [No4b](https://github.com/justNo4b) | 3179 | 3230 | Drofa started as a fork of the Shallow Blue chess engine - it's now much stronger, and is among the strong HCE engines. |
| [Svart](https://github.com/crippa1337/svart) 5 | [Crippa](https://github.com/crippa1337) | 3176 | 3257 | Written in Rust! |
| [Willow](https://github.com/Adam-Kulju/Willow) 3.0 | [Adam Kulju](https://github.com/Adam-Kulju) | ~3171 | 3246 | The world's strongest mailbox engine. It features a net that is trained on games with intentional mistakes, to increase strength and foster an aggressive style of play... or that's the hope, at least. |
| [Nalwald](https://gitlab.com/tsoj/Nalwald) 17.1 | [tsoj](https://gitlab.com/tsoj) | 3146 | ↓3197 | Alpha-beta engine with BAE, written in Nim. |
| [Carp](https://github.com/dede1751/carp) 2.0.0 | [dede1751](https://github.com/dede1751) | 3086 | 3164 | Written in Rust! |
| [Altair](https://github.com/Alex2262/AltairChessEngine) 4.0.0 | [Antares](https://github.com/Alex2262) | 3042 | 3083 | 10x12 mailbox C++ engine. |
| [Polaris](https://github.com/Ciekce/Polaris) 1.8.1 | [Ciekce](https://github.com/Ciekce) | 2983 | 3060 | "author has a catboy as pfp" ~ crippa<br />C++20 HCE engine that does not care about king safety! |
| [Midnight](https://github.com/archishou/MidnightChessEngine) 7 | [archi](https://github.com/archishou) | 2979 | 3114 | "it be an engine" - archi |
| [Peacekeeper](https://github.com/Sazgr/peacekeeper) 1.60 | [Sazgr](https://github.com/Sazgr) | 2976 | 3053 | A C++ engine which formerly had simple evaluation, still sucks at LTC, and has 2.19999999 in its code. |
| [4ku](https://github.com/kz04px/4ku) 3.1 | [kz04px](https://github.com/kz04px), [Gedas](https://github.com/GediminasMasaitis), [Gian-Carlo Pascutto](https://github.com/gcp), and [others](https://github.com/kz04px/4ku/graphs/contributors) | ~2871 | ↓2921 | A UCI chess engine in 4 kB. The 4ku-mini script contains compressed C++ source code, that is extracted and compiled before being run. Written to take part in the [TCEC's 4K tournament](https://wiki.chessdom.org/TCEC_4k_Rules) |
| [ice4](https://github.com/MinusKelvin/ice4) v3.1 | [MinusKelvin](https://github.com/MinusKelvin) & [Analog Hors](https://github.com/analog-hors) | ~2795 | * | ice4 is a chess engine which fits in 4096 bytes. Written to take part in the [TCEC's 4K tournament](https://wiki.chessdom.org/TCEC_4k_Rules) |
| [Mess](https://github.com/raklaptudirm/mess) 0.3.0 | [Rak Laptudirm](https://github.com/raklaptudirm) | 2760 | 2819 | Written in Go! |
| [Pedantic](https://github.com/JoAnnP38/Pedantic) 0.4.1 | [JoAnnP38](https://github.com/JoAnnP38) | ↓2747 | ↓2749 | Written in C#! |
| [Apotheosis](https://github.com/spamdrew128/Apotheosis) 4.0.1 | [Spamdrew](https://github.com/spamdrew128) | 2744 | 2780 | Apotheosis is a blunder-prone silly lil guy that sometimes plays cool chess. |
| [Princhess](https://github.com/princesslana/princhess) 0.12.0 | [princesslana](https://github.com/princesslana) | ~2738 | 2791 | CPU-only MCTS engine in Rust! |
| [Akimbo](https://github.com/JacquesRW/akimbo) 0.4.1 | [JacquesRW](https://github.com/JacquesRW) | ↓2724 | ↓2760 | Small engine written in Rust. |
...
| [Cheers](https://github.com/Algorhythm-sxv/Cheers) 0.2.2 | [Algorhythm](https://github.com/Algorhythm-sxv) | 2642 | ↓2659 | A Rust HCE engine! |
| [Baislicka](https://github.com/kz04px/Baislicka) 1.0 | [kz04px](https://github.com/kz04px) | 2208 | 2255 | A chess engine written in C. Uses bitboards with fixed shift fancy movegen. |
...
| [Stormphrax](https://github.com/Ciekce/Stormphrax) 1.0.0 | [Ciekce](https://github.com/Ciekce) | 3511 |
